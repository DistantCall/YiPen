...
public class MainActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        mBottomTabBar.init(getSupportFragmentManager())
                .addTabItem("首页", R.mipmap.main,  HomeFragment.class)
                .addTabItem("商城", R.mipmap.shop, ShopFragment.class)
                .addTabItem("我的", R.mipmap.mine, MineFragment.class).setChangeColor(Color.BLUE,Color.BLACK);
    }
